...
GitHub's [private vulnerability reporting](https://github.com/ahmeddoghri/clarifyrag/security/advisories/new)
...
`clarifyrag` is a pure-stdlib library with no runtime dependencies and makes no
